...
- A session may carry skills or tools from any vendor that implement these
  habits, and they are used as working tools. None of them is part of Joserah,
  and none is ever written into it — Joserah studies how others solve a problem
  and writes its own small version, under its own name. (This was policy text
